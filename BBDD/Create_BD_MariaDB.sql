CREATE TABLE TMARCAJE (
  ...
  COD_BIO integer,
  DES_FOTO varchar(20) NULL,
  COD_TIPO_ACCESO integer,
  FEC_MARCAJE datetime,
  HOR_MARCAJE datetime,
  FEC_GRABACION datetime,
  HOR_GRABACION datetime,
  IND_INCIDENCIA boolean NULL,
  IND_PENDIENTE boolean NULL,  
  DES_OBSERVACIONES varchar(100) NULL
);

CREATE TABLE TTIPOACCESO (
  COD_TIPO_ACCESO integer AUTO_INCREMENT PRIMARY KEY,
  DES_TIPO_ACCESO varchar(20)
);
...
CREATE TABLE TUSUARIO (
  ...
  DES_CONTRASENA varchar(20),
  DES_CORREO varchar(20),
  FEC_ALTA datetime,
  NOM_USUARIO_ALTA varchar(20),
  FEC_BAJA DATETIME NULL,
  NOM_USUARIO_BAJA varchar(20) NULL
...
CREATE TABLE TAJUSTE(
  ID_AJUSTE integer AUTO_INCREMENT PRIMARY KEY,
  NOM_AJUSTE varchar(20),
  VALOR_AJUSTE varchar(20)
); 
...
ALTER TABLE TMARCAJE ADD FOREIGN KEY (COD_TIPO_ACCESO) REFERENCES TTIPOACCESO (COD_TIPO_ACCESO);
